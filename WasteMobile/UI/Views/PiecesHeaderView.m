...
- (void) drawHeaderForScale: (BOOL) userCreated{
    ...
    UILabel *lblPieceVolumn = [[UILabel alloc] initWithFrame:CGRectMake(846, 0, 146, 42)];
    lblPieceVolumn.text = @" Piece Volume ";
...
- (void) drawHeaderForPlot: (BOOL) userCreated{
    ...
    UILabel *lblPieceVolumn = [[UILabel alloc] initWithFrame:CGRectMake(861, 0, 130, 42)];
    lblPieceVolumn.text = @" Piece Volume ";
    lblPieceVolumn.backgroundColor = [UIColor piecesHeaderRed];
